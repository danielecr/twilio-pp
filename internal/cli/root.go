...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "twilio-jobs-pp-cli-pp-cli",
		Short: "Manage twilio-jobs-pp-cli resources via the twilio-jobs-pp-cli API",
		Long: `Manage twilio-jobs-pp-cli resources via the twilio-jobs-pp-cli API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'twilio-jobs-pp-cli-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("twilio-jobs-pp-cli-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'twilio-jobs-pp-cli-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTwilioCareersJobsCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("twilio-jobs-pp-cli-pp-cli %s\n", version)
		},
	}
}
