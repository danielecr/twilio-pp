...
but do not stop the import.`,
  ...
  twilio-jobs-pp-cli-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  twilio-jobs-pp-cli-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | twilio-jobs-pp-cli-pp-cli import <resource> --input -`,
