...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  twilio-jobs-pp-cli-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  twilio-jobs-pp-cli-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"twilio-careers-jobs"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  twilio-jobs-pp-cli-pp-cli workflow status

  # Show status as JSON
  twilio-jobs-pp-cli-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("twilio-jobs-pp-cli-pp-cli")
			}
